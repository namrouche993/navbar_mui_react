...
function Googlesheetiframe() {
  const refgh = useRef(null);
  const refinput = useRef(null);
  
  
    function Focusingooglesheet() {
...
<Button
    ...
    <Button 
     onClick={Focusingooglesheet}
     variant='contained' color='primary'>
        Focus
    </Button>
    <br></br>
    <br></br>
    <TextField label='Tapez qlq chose ici' variant='outlined' id='inputref' inputRef={refinput} type="text" />
    <br></br>
...
export default Googlesheetiframe
